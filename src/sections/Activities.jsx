...
const ACTIVITIES = {
  viatges: [
    {
      id: 1,
      titol: 'Eivissa & Formentera',
      subtitol: 'Juliol 2022',
      descripcio: 'El primer viatge junts. Mar, sal i la sensació que tot just començàvem.',
      color: '#E8C5B8',
      accent: '#C97B5A',
    },
    {
      ...
      titol: 'Bèlgica',
      subtitol: 'Agost 2022',
      descripcio: 'Gant, Brussel·les, Bruges. Cervesa, xocolata i carrers de pedra.',
      color: '#D4C5A9',
      accent: '#8A6A3A',
    },
    {
      ...
      titol: 'Sud d\'Espanya',
      subtitol: 'Agost 2023',
      descripcio: 'Mora la Nova, Còrdova, Jerez, Conca. Carretera, calor i nosaltres dos.',
      color: '#F0D8C0',
      accent: '#A05A20',
    },
    {
      id: 4,
      titol: 'Eindhoven',
      subtitol: 'Tardor 2023',
      descripcio: "L'Erasmus d'ella. La vaig anar a veure dos cops perquè no podia estar-me quiet.",
      color: '#B8C8D4',
      accent: '#3A6A8A',
    },
    {
      ...
      descripcio: 'Bolonya, Florència, Milà. I la millor carbonara de la nostra vida.',
      color: '#D4B8C8',
      accent: '#6A3A5A',
    },
    {
      id: 6,
      titol: 'Nord d\'Espanya',
      subtitol: 'Agost 2025',
      descripcio: 'Saragossa, Lleó, Santiago, Burgos. La carretera com a excusa.',
      color: '#C8D4B8',
      accent: '#4A6A3A',
    },
    {
      id: 7,
      titol: 'Filipines',
      subtitol: 'Setembre 2025',
      descripcio: 'Coron, El Nido, Bohol. El viatge que ens va canviar l\'escala.',
      color: '#B8D4D0',
      accent: '#2A6A65',
    },
    {
      id: 8,
      titol: 'Andorra',
      subtitol: 'Febrer 2026',
      descripcio: 'Andorra la Vella. Petit, tranquil i nostre.',
      color: '#E8D4B8',
      accent: '#8A5A2A',
    },
  ],
